...
const BMICalculator = () => {
    ...
    // handleSubmit
   const handleSubmit = ()=>{
    // const BmiData ={bmiResult,status,height,weight,user.email,user.name}
                        ...
                        <div className="card-body">
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text">Weight <span className="text-xs font-semibold text-gray-600">(cm)</span> </span>
                                </label>
                            ...
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text">Height <span className="text-xs font-semibold text-gray-600">(cm)</span> </span>
                                </label>
                                ...
                                bmiResult ? (
                                    <div>
                                        ...
                                        <p>Your BMI is: {bmiResult}</p>
                                         <button onClick={handleSubmit} className="flex items-center relative w-28  border-2 border-[#409bd4] text-[#409bd4] px-4 py-2 rounded-full group mt-4"><span>Save</span><span className="absolute w-1/6 right-3 group-hover:w-5/6 box-content duration-300 flex justify-center bg-white rounded-full">
