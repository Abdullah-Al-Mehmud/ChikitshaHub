...
const AboutUs = () => {
    return (
        <div>
                ...
                <div className="w-full bg-black bg-opacity-70 lg:pb-40 lg:pt-36 md:pb-28 md:pt-24 pb-20 pt-16">
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="pt-10 text-[#ffffffea] w-full lg:text-left text-center">
                            ...
                            <p className="font-medium text-white mt-1">Home &gt; <span className="text-[#409bd4]">About Us</span></p>
                        </div>
                    </div>
                </div>
            ...
            <p>Welcome to Chikitshahub, your trusted destination for hassle-free online doctor appointments. At Chikitshahub, we believe that your health is a priority, and we&#39;ve crafted a platform that ensures convenient access to quality healthcare from the comfort of your home.</p>
            <br />
            <p>Our mission is simple – to revolutionize the way you book and experience doctor appointments. No more waiting in lines or dealing with complicated scheduling. Chikitshahub brings you a seamless online platform that connects you with experienced healthcare professionals across various specialties.</p>
            </div>
        </div>
    );
};
